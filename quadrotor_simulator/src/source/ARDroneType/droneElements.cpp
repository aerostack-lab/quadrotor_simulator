...
{
    altitudeOut=altitude+cvg_normal_distribution(NOISE_MEAN_AltitudeSensor,NOISE_STD_AltitudeSensor);
    varAltitudeOut=varAltitude+cvg_normal_distribution(NOISE_MEAN_AltitudeSensor,NOISE_STD_AltitudeSensor);
    return 1;
}
...
{
    altitudeSpeedOut=altitudeSpeed+cvg_normal_distribution(NOISE_MEAN_AltitudeSensor,NOISE_STD_AltitudeSensor);
    varAltitudeSpeedOut=varAltitudeSpeed+cvg_normal_distribution(NOISE_MEAN_AltitudeSensor,NOISE_STD_AltitudeSensor);
    return 1;
}
...
{
    yawOut=yaw+cvg_normal_distribution(NOISE_MEAN_RotationAnglesSensor,NOISE_STD_RotationAnglesSensor);
    pitchOut=pitch+cvg_normal_distribution(NOISE_MEAN_RotationAnglesSensor,NOISE_STD_RotationAnglesSensor);
    rollOut=roll+cvg_normal_distribution(NOISE_MEAN_RotationAnglesSensor,NOISE_STD_RotationAnglesSensor);
    return 1;
}
...
{
    vxOut=vx+cvg_normal_distribution(NOISE_MEAN_GroundSpeedSensor,NOISE_STD_GroundSpeedSensor);
    vyOut=vy+cvg_normal_distribution(NOISE_MEAN_GroundSpeedSensor,NOISE_STD_GroundSpeedSensor);
    return 1;
}
