...
void QuadrotorSimulator::init(const std::string &file){
    ...
    try {
        XMLFileReader my_xml_reader(file);
...
//    }
    ...
    //DroneImu; //TODO, and put on quadrotor_simulator Constructor
...
void QuadrotorSimulator::setPosition_drone_GMR_wrt_GFF(double x_in, double y_in, double z_in, double yaw_in, double pitch_in, double roll_in)
{
...
void QuadrotorSimulator::setPosition_drone_LMrT_wrt_LMrTFF(double x_in, double y_in, double z_in, double yaw_in, double pitch_in, double roll_in)
{
    current_xg = x_in;      current_yg = -y_in;         current_zg = -z_in;
    current_yawg = -yaw_in; current_pitchg = -pitch_in; current_rollg = roll_in;
...
void QuadrotorSimulator::setSpeed_drone_GMR_wrt_GFF(double vx_in, double vy_in, double vz_in)
{
    current_vxg = vx_in; current_vyg = vy_in;  current_vzg = vz_in;
    current_vxl = vx_in; current_vyl = -vy_in; current_vzl = -vz_in;
}

void QuadrotorSimulator::setSpeed_droneLMrT_wrt_LMrTFF(double vx_in, double vy_in, double vz_in)
{
    current_vxg = vx_in; current_vyg = -vy_in; current_vzg = -vz_in;
    current_vxl = vx_in; current_vyl = vy_in;  current_vzl = vz_in;
}

void QuadrotorSimulator::getPosition_drone_GMR_wrt_GFF(double &x_in, double &y_in, double &z_in, double &yaw_in, double &pitch_in, double &roll_in)
{
    x_in = current_xg;     y_in = current_yg;         z_in = current_zg;
    yaw_in = current_yawg; pitch_in = current_pitchg; roll_in = current_rollg;
}

void QuadrotorSimulator::getPosition_drone_LMrT_wrt_LMrTFF(double &x_in, double &y_in, double &z_in, double &yaw_in, double &pitch_in, double &roll_in)
{
    x_in = current_xl;     y_in = current_yl;         z_in = current_zl;
    yaw_in = current_yawl; pitch_in = current_pitchl; roll_in = current_rolll;
}

void QuadrotorSimulator::getSpeed_drone_GMR_wrt_GFF(double &vx_in, double &vy_in, double &vz_in)
{
    vx_in = current_vxg;     vy_in = current_vyg;         vz_in = current_vzg;
}

void QuadrotorSimulator::getSpeed_droneLMrT_wrt_LMrTFF(double &vx_in, double &vy_in, double &vz_in)
{
    vx_in = current_vxl;     vy_in = current_vyl;         vz_in = current_vzl;
}

//void QuadrotorSimulator::getPosition_drone_GMR_wrt_GFF_noisy(double &x_in, double &y_in, double &z_in, double &yaw_in, double &pitch_in, double &roll_in)
//{
...
void QuadrotorSimulator::preconditionCheck()
{
    //    precondition_check_variables  = true;
}

bool QuadrotorSimulator::processState()
{
    bool is_successful = true;
...
void QuadrotorSimulator::stateTransitionCheck()
{
...
void QuadrotorSimulator::postProcessInputs()
{
    switch (current_drone_state) {
    case DroneState::TAKING_OFF:
    {
...
void QuadrotorSimulator::postProcessOutputs()
{
...
void QuadrotorSimulator::startUnknownState()
{
    current_drone_state = DroneState::UNKNOWN;
}

void QuadrotorSimulator::startLandedState()
{
    current_drone_state = DroneState::LANDED;
}

void QuadrotorSimulator::startTakingOffState()
{
...
void QuadrotorSimulator::startHoveringState()
{
    current_drone_state = DroneState::HOVERING;
}

void QuadrotorSimulator::startFlyingState()
{
...
void QuadrotorSimulator::startLandingState()
{
...
void QuadrotorSimulator::commandDrone(DroneStateCommand::StateCommand drone_state_command)
{
